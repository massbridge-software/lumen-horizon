...
<head>
    ...
    <link href="{{ asset('vendor/horizon/'.$cssFile) }}" rel="stylesheet">
</head>
<body>
<div id="horizon" v-cloak>
    ...
    <div class="container mb-5">
        <div class="d-flex align-items-center py-4 header">
            ...
            <h4 class="mb-0 ml-2"><strong>{{ config('app.name') ? config('app.name') : '' }}</strong></h4>
...
<script src="{{asset('vendor/horizon/app.js')}}"></script>
</body>
</html>
